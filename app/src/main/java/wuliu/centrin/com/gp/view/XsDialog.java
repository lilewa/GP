...
import wuliu.centrin.com.gp.util.SharePreUtil;
...
public class XsDialog extends Dialog {
    ...
    public XsDialog setView(View view) {
        ...
        // 3.添加新的View
        LinearLayout.LayoutParams layoutParamsFW = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
